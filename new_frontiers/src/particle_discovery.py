...
def discover_particles():
    ...
    print("\n--- Composites Hadrons and Atoms ---")
    strong_force_uu = ExtensionClass("Strong Force U-U", 10.0)
    u_u = machine.exact_sequence_reconstruction(up_red, up_blue, ext=strong_force_uu)
    
    strong_force_uud = ExtensionClass("Strong Force UU-D", 929.1)
    proton = machine.exact_sequence_reconstruction(u_u, down_green, ext=strong_force_uud)
